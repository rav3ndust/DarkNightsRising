...
function menu3 {
 	dialog --msgbox "The voices spoke the following:" 100 50
}
function voice4 {
...
function menuPrompt {
	dialog --msgbox "Think carefully, because you only get one chance here. What would you like to say to the demons? Do you choose to RESIST, or ASSIMILATE? Press ENTER to continue." 100 50
}
...
function statementMenu1 {
	dialog --msgbox "'I refuse.' You say calmy to the Demons. 'I will not assimilate with you. I refuse to give you any control over my brain.'" 100 50
}
...
function statementMenu2 {
	dialog --msgbox "The Demons are not happy about your decision. They shout a shrill, hellish scream, bringing the very feeling of dread itself into your soul." 100 50 
}
function statementVoice3 {
	flite -voice rms "Next, the demons have this to say."
}
function statementMenu3 {
	dialog --msgbox "Next, the Demons have this to say:" 100 50
}
...
function menu7 {
	dialog --msgbox "'We will be back. Your day of reckoning is upon you, $CHARNAME!'" 100 50
}
function voice8 {
